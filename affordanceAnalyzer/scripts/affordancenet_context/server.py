...
sys.path.append('/workspace/affordanceNet_Context/lib')
...
class AffordanceAnalyzer(object):
    ...
    def __init__(self):
        ...
        self.cwd = os.getcwd()
        self.root_path = '/workspace/affordanceNet_Context/'
        self.img_folder = self.cwd + '/img'
        cfg.TEST.HAS_RPN = True
        self.name = "affordancenet_context"
        ...
        print 'AffordanceNet_Context root folder: ', self.root_path
    ...
    def run_net(self, im, CONF_THRESHOLD = 0.7):
    ...
    def analyzeAffordance(self, msg):
        ...
        try:
            bbox, objects, masks, scores = self.run_net(img, CONF_THRESHOLD=self.CONF_THRESHOLD)
            bbox = bbox[:,1:]
            m = masks[0]
    ...
    def startAffordance(self, msg):
        ...
        caffemodel = self.root_path + '/pretrained/vgg16_faster_rcnn_iter_110000_pam_7attribute.caffemodel'
