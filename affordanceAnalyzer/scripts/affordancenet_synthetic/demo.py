...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset_name',
                        help='Dataset which the network was trained on [IIT-AFF, UMD]',
    ...
    for img_count, img_f in enumerate(imgs):
        ...
        try:
            ...
            for box, label, mask, score in zip(boxes, labels, masks, scores):
                ...
                img_vis = cv2.putText(img_vis, text, (box[0], int(y_rb-10)), cv2.FONT_HERSHEY_SIMPLEX, fontscale, (255, 255, 255), 2, 2)
